<div class="p-4">
    ...
    <h5 class="text-xl font-bold leading-none text-gray-900 mb-4 dark:text-white">User</h5>
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <th scope="row" class="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">
                                {{ $user->person->firstname ?? 'Belum mengisi nama' }}
                            </th>
                            <td class="px-6 py-4">
                            {{ $user->username }}
                            </td>
                            ...
                            <td class="px-6 py-4">
                            {{ $user->person->phone ?? 'Belum mengisi no telepon' }}
                            </td>
                            <td class="px-6 py-4">
                            {{ $user->role->name ?? 'Belum diberi role' }}
                            </td>
                            <td class="px-6 py-4 text-right">
                                <button wire:click="giveRole({{ $user->id }})" class="font-medium text-blue-600 dark:text-blue-500 hover:underline" >Beri Role</button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
